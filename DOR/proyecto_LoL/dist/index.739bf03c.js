...
})({"17Bfm":[function(require,module,exports) {
...
var _championsJs = require("./champions.js");
var _championsJsDefault = parcelHelpers.interopDefault(_championsJs);
...
async function get_champions() {
    ...
    for(const key in data)champions.push(new (0, _championsJsDefault.default)(data[key]));
    showChampions();
}
get_champions();
const showChampions = async ()=>{
    ...
    for (const champion of champions){
        let playstyle = "";
        let stats = "";
        if (champion.playstyle !== undefined) playstyle = `<b>Playstyle:</b> ${champion.playstyle}`;
        for(let stat in champion.stats)stats += `<b>${stat}:</b> ${champion.stats[stat]}<br>`;
        ...
        <div class="detail">
            ...
            <p><b>T\xedtulo:</b> ${champion.title}</p>
    ...
    closeButtons.forEach((button)=>{
        button.addEventListener("click", (0, _detailJs.close_detail));
    });
    (0, _detailJs.show_detail)();
    aux++;
};

},{"./champions.js":"ftYrc","./detail.js":"Tm9d6","@parcel/transformer-js/src/esmodule-helpers.js":"fS6N2"}],"ftYrc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"fS6N2"}],"fS6N2":[function(require,module,exports) {
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "show_detail", ()=>show_detail);
parcelHelpers.export(exports, "close_detail", ()=>close_detail);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"fS6N2"}]},["17Bfm","ebWYT"], "ebWYT", "parcelRequire94c2")
